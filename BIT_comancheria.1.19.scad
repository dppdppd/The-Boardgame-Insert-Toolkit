...
include <boardgame_insert_toolkit_lib.1.19.scad>;
                ...
                [
                    ...
                    [   "dice",
                        [
                            ...
                            sha,    
                            ["margin",                          [0,1,1,1]],                     // BOTTOM,TOP,LEFT,RIGHT
                            ["padding",                         [11, 8 ]],                     // [float,float]
                            ["position",                        [128, 32 ] ],                // [float, float, float]  
                            ["label",               
                                [
                                    ["text",        "dice"],
                                    ["placement",   "center"],          // center | below | above | left | right
