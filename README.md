...
- **Validation**: typos, wrong value types, and known physical fit/printability risks produce structured `BGSD_WARNING:` messages in the console (set `g_validate_keys_b = false;` to suppress)
