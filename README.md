...
<!-- TOC -->autoauto- [Why](#why)auto- [How](#how)auto        - [Pay attention to your dimensions.](#pay-attention-to-your-dimensions)auto    - [Key Values](#key-values)auto        - [Some Explanation](#some-explanation)auto        - [Dividers](#dividers)auto- [Keys](#keys)auto            - [`TYPE`](#type)auto        - [Box keys](#box-keys)auto            - [`BOX_DIMENSIONS`](#box_dimensions)auto            - [`BOX_COMPONENTS`](#box_components)auto            - [`BOX_VISUALIZATION`](#box_visualization)auto            - [`BOX_LID_NOTCHES`](#box_lid_notches)auto            - [`BOX_LID_HEX_RADIUS`](#box_lid_hex_radius)auto            - [`BOX_LID_FIT_UNDER`](#box_lid_fit_under)auto            - [`BOX_LID`](#box_lid)auto            - [`BOX_THIN_LID`](#box_thin_lid)auto        - [Dividers](#dividers-1)auto        - [Dividers keys](#dividers-keys)auto            - [`DIV_THICKNESS`](#div_thickness)auto            - [`DIV_FRAME_HEIGHT`](#div_frame_height)auto            - [`DIV_FRAME_WIDTH`](#div_frame_width)auto            - [`DIV_FRAME_TOP`](#div_frame_top)auto            - [`DIV_FRAME_BOTTOM`](#div_frame_bottom)auto            - [`DIV_FRAME_COLUMN`](#div_frame_column)auto            - [`DIV_FRAME_RADIUS`](#div_frame_radius)auto            - [`DIV_FRAME_NUM_COLUMNS`](#div_frame_num_columns)auto            - [`DIV_TAB_WIDTH`](#div_tab_width)auto            - [`DIV_TAB_HEIGHT`](#div_tab_height)auto            - [`DIV_TAB_RADIUS`](#div_tab_radius)auto            - [`DIV_TAB_CYCLE`](#div_tab_cycle)auto            - [`DIV_TAB_TEXT`](#div_tab_text)auto            - [`DIV_TAB_TEXT_SIZE`](#div_tab_text_size)auto            - [`DIV_TAB_TEXT_FONT`](#div_tab_text_font)auto            - [`DIV_TAB_TEXT_SPACING`](#div_tab_text_spacing)auto            - [`DIV_TAB_TEXT_CHAR_THRESHOLD`](#div_tab_text_char_threshold)auto        - [Compartment keys](#compartment-keys)auto            - [`CMP_NUM_COMPARTMENTS`](#cmp_num_compartments)auto            - [`CMP_COMPARTMENT_SIZE`](#cmp_compartment_size)auto            - [`CMP_SHAPE`](#cmp_shape)auto            - [`CMP_SHAPE_ROTATED`](#cmp_shape_rotated)auto            - [`CMP_SHAPE_VERTICAL`](#cmp_shape_vertical)auto            - [`CMP_PADDING`](#cmp_padding)auto            - [`CMP_PADDING_HEIGHT_ADJUST`](#cmp_padding_height_adjust)auto            - [`CMP_MARGIN`](#cmp_margin)auto            - [`CMP_CUTOUT_SIDES`](#cmp_cutout_sides)auto            - [`CMP_SHEAR`](#cmp_shear)auto            - [`LABEL`](#label)auto        - [Label keys](#label-keys)auto            - [`LBL_TEXT`](#lbl_text)auto            - [`LBL_SIZE`](#lbl_size)auto            - [`LBL_SPACING`](#lbl_spacing)auto            - [`LBL_PLACEMENT`](#lbl_placement)auto            - [`LBL_FONT`](#lbl_font)auto            - [`LBL_DEPTH`](#lbl_depth)auto            - [`ROTATION`](#rotation)auto            - [`POSITION`](#position)auto            - [`ENABLED`](#enabled)auto- [Published inserts:](#published-inserts)autoauto<!-- /TOC -->
