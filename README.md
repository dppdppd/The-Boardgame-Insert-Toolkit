...
- [Keys](#keys)
        ...
        - [Box keys](#box-keys)
            ...
            - [`BOX_LID_NOTCHES`](#box_lid_notches)
            - [`BOX_LID_HEX_RADIUS`](#box_lid_hex_radius)
            - [`BOX_LID_FIT_UNDER`](#box_lid_fit_under)
            - [`BOX_LID`](#box_lid)
            - [`BOX_THIN_LID`](#box_thin_lid)
        - [Dividers](#dividers-1)
        - [Dividers keys](#dividers-keys)
            - [`DIV_THICKNESS`](#div_thickness)
            - [`DIV_FRAME_HEIGHT`](#div_frame_height)
            - [`DIV_FRAME_WIDTH`](#div_frame_width)
        ...
        - [Compartment keys](#compartment-keys)
            - [`CMP_NUM_COMPARTMENTS`](#cmp_num_compartments)
            - [`CMP_COMPARTMENT_SIZE`](#cmp_compartment_size)
            - [`CMP_SHAPE`](#cmp_shape)
            - [`CMP_SHAPE_ROTATED`](#cmp_shape_rotated)
            - [`CMP_SHAPE_VERTICAL`](#cmp_shape_vertical)
            - [`CMP_PADDING`](#cmp_padding)
            - [`CMP_PADDING_HEIGHT_ADJUST`](#cmp_padding_height_adjust)
            - [`CMP_MARGIN`](#cmp_margin)
            - [`CMP_CUTOUT_SIDES`](#cmp_cutout_sides)
            - [`CMP_SHEAR`](#cmp_shear)
            - [`LABEL`](#label)
