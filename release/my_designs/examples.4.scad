...
data = [
    ...
    [ OBJECT_BOX,
        ...
        [ BOX_FEATURE,
            ...
            [ POSITION_XY, [0 * cmp_pitch, 0 * cmp_pitch] ],
        ],
        // fillet
        [ BOX_FEATURE,
            [ FTR_COMPARTMENT_SIZE_XYZ, [cmp_size, cmp_size, cmp_size] ],
            [ POSITION_XY, [1 * cmp_pitch, 0 * cmp_pitch] ],
            [ FTR_SHAPE, FILLET ],
            [ FTR_FILLET_RADIUS, 5 ],
        ],
        // fillet rotated
        ...
        [ BOX_FEATURE,
            [ FTR_COMPARTMENT_SIZE_XYZ, [cmp_size, cmp_size, cmp_size] ],
            [ POSITION_XY, [2 * cmp_pitch, 0 * cmp_pitch] ],
            [ FTR_SHAPE, ROUND ],
        ],
        // round rotated
        [ BOX_FEATURE,
        ...
        [ BOX_FEATURE,
            [ FTR_COMPARTMENT_SIZE_XYZ, [cmp_size, cmp_size, cmp_size] ],
            [ POSITION_XY, [2 * cmp_pitch, 2 * cmp_pitch] ],
            [ FTR_SHAPE, ROUND ],
        ...
        [ BOX_FEATURE,
            [ FTR_COMPARTMENT_SIZE_XYZ, [cmp_size, cmp_size, cmp_size] ],
            [ POSITION_XY, [3 * cmp_pitch, 0 * cmp_pitch] ],
            [ FTR_SHAPE, HEX ],
        ],
        // hex rotated
        [ BOX_FEATURE,
        ...
        [ BOX_FEATURE,
            [ FTR_COMPARTMENT_SIZE_XYZ, [cmp_size, cmp_size, cmp_size] ],
            [ POSITION_XY, [3 * cmp_pitch, 2 * cmp_pitch] ],
            [ FTR_SHAPE, HEX ],
            [ FTR_SHAPE_VERTICAL_B, t ],
        ],
        // hex2
        [ BOX_FEATURE,
            [ FTR_COMPARTMENT_SIZE_XYZ, [cmp_size, cmp_size, cmp_size] ],
            [ POSITION_XY, [4 * cmp_pitch, 0 * cmp_pitch] ],
            [ FTR_SHAPE, HEX2 ],
        ],
        // hex2 rotated
        [ BOX_FEATURE,
        ...
        [ BOX_FEATURE,
            [ FTR_COMPARTMENT_SIZE_XYZ, [cmp_size, cmp_size, cmp_size] ],
            [ POSITION_XY, [4 * cmp_pitch, 2 * cmp_pitch] ],
            [ FTR_SHAPE, HEX2 ],
            [ FTR_SHAPE_VERTICAL_B, t ],
        ],
        // oct
        [ BOX_FEATURE,
            [ FTR_COMPARTMENT_SIZE_XYZ, [cmp_size, cmp_size, cmp_size] ],
            [ POSITION_XY, [5 * cmp_pitch, 0 * cmp_pitch] ],
            [ FTR_SHAPE, OCT ],
        ],
        // oct rotated
        [ BOX_FEATURE,
        ...
        [ BOX_FEATURE,
            [ FTR_COMPARTMENT_SIZE_XYZ, [cmp_size, cmp_size, cmp_size] ],
            [ POSITION_XY, [5 * cmp_pitch, 2 * cmp_pitch] ],
            [ FTR_SHAPE, OCT ],
            [ FTR_SHAPE_VERTICAL_B, t ],
        ],
        // oct2
        [ BOX_FEATURE,
            [ FTR_COMPARTMENT_SIZE_XYZ, [cmp_size, cmp_size, cmp_size] ],
            [ POSITION_XY, [6 * cmp_pitch, 0 * cmp_pitch] ],
            [ FTR_SHAPE, OCT2 ],
        ],
        // oct2 rotated
        [ BOX_FEATURE,
        ...
        [ BOX_FEATURE,
            [ FTR_COMPARTMENT_SIZE_XYZ, [cmp_size, cmp_size, cmp_size] ],
            [ POSITION_XY, [6 * cmp_pitch, 2 * cmp_pitch] ],
            [ FTR_SHAPE, OCT2 ],
            [ FTR_SHAPE_VERTICAL_B, t ],
        ],
        [ BOX_LID,
            [ LID_INSET_B, t ],
            [ LID_PATTERN_RADIUS, 12 ],
        ],
    ],
    [ OBJECT_DIVIDERS,
