...
function __is_string( s ) = is_string( s );


// is the text a string or a list of strings?
function __is_multitext( label ) = !__is_string( __value( label, "text" ) ) && is_list(__value( label, "text" ));
...
///////////////////////
       ...
       module MakeBottomsRounded()
        ...
        module MakeBottoms()
        {
            ...
            r = __is_shape_square() ? __compartment_size( __X2() ) / 2 : __compartment_size( __X2() ) / 2 / cos( 30 / $fn )  ;
            ...
            translate( translation )
            {
                ...
                { 
                    ...
                    union()
                    {
                        ...
                        cylinder_translation = __RotatedResult( _0 = [ __compartment_size( X )/2, __compartment_size( Y ) , r ],
                                                                _90 = [ 0 , (__compartment_size( Y ) )/2 , r ],
                                                                _180 = [ __compartment_size( X )/2 , __compartment_size( Y ), r ],
                        ...
                        translate( cylinder_translation )
                        {
                                    ...
                                    v=[ 0, 0, 1])
                            {
                                        ...
                                        v=[ 1, 0, 0 ] )
                                {
                                    ...
                                    rotate( a=__is_shape_hex_rotated() ? 30 : 0, 
                                            v=[ 0, 0, 1])
                                    {
                                        cylinder(h = __compartment_size( __Y2() ), r1 = r, r2 = r );  
                                    }
        ...
        module ShapeCompartment()
        {
            ...
            translate( cylinder_translation )
            {
                rotate( a=__is_shape_square() ? 45 : 30, 
                        v=[0, 0, 1] )
                {
