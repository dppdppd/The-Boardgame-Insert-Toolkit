...
export function generateScad(project: Project): string {
  ...
  out.push("// Generated by BIT GUI — do not edit manually");
  out.push("");
  out.push('include <lib/boardgame_insert_toolkit_lib.4.scad>;');
  out.push('include <lib/bit_functions_lib.4.scad>;');
  out.push("");
